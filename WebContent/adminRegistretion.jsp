...
<html>
    <head>
        <title>Admin Registretion</title>
                <link href="adminRegistretion2.css" rel="stylesheet" type="text/css"/>
        
        <link href="adminRegistretion.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div class="mainmenu">
        <div class="menu">
    ...
    <div class="reg1">
       ...
       <div class="reg3">
       <form action="AdminRegistretionServlet" method="post">
       <br>
       <input type="text" name="admin" id="name" placeholder="Name" value="<% 
       ...
       %></lable>
       <br>
       <input type="text" name="eid" id="city" placeholder="Employee ID" value="<% 
       String ci=request.getParameter("eid");
       if(ci!=null)
       {
    	   out.print(ci);
       }
