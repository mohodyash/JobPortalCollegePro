...
<html>
    ...
    <body>
        ...
        <div class="list">                                                           <!-- list -->
            <ul>
                ...
                <li><a href="aboutus.jsp"><p style="color: rgb(255,255,0)"> ABOUT US</p></a></li>
    ...
    %></p></a>
      ...
      <div style="margin-top: 150px; margin-bottom: 100px; margin-left: 380px; font-size: 22px;">
         <br>
          <label>Job portal is an application which connects employer<br>
                 and job seekers where employers are the source of the<br> 
                 resource and the job seeker can find and apply for their<br>
                 targeted job.</label><br><br>
          <label>This document provides details about the entire software<br> 
                 requirement specification for the Online Job Portal.</label>
      </div>
