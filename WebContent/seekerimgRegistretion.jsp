...
<html>
    <head>
        ...
        <link href="seekerimgRegistretion.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div class="mainmenu">
        <div class="menu">
        ...
        <div class="list">                                                           <!-- list -->
            <ul>
                ...
                <li><a href="http://localhost:8082/JobPortalCollegePro/login.jsp"><p>LOGIN </p></a></li>
    ...
    <div class="log">
       ...
       <label style="color: grey; font-family: inherit; font-size: 18px;">choose a profile photo</label>
       <input type="file" name="img" id="im" placeholder="choose a profile photo"><br><br>
