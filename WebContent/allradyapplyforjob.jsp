...
<html>
    <head>
        <title>All Ready apply for Job</title>
    ...
    <div style="margin-left: 250px; margin-top: 50px; color: gray;">
     ...
     <h3 style="margin-top: 10px;">* Sorry You All Ready Apply For This Job </h3>
     <h3 style="margin-top: 10px;">* If You All Ready Apply For This Job You Can Not Apply Again </h3>
