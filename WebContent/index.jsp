...
<html>
    ...
    <body>
        ...
        <div class="list">                                                           <!-- list -->
            <ul>
                <li><a href="http://localhost:8082/JobPortalCollegePro/"><p style="color: rgb(255,255,0)">HOME</p></a></li>
                <li><a href="./test2">  LOGIN </a></li>
                <li><a href="./test3">  REGISTER</a></li>
    ...
    <div class="search2">
       ...
       <input type="submit" value="SEARCH" id="button">
        ...
        <div class="error">
       <label style="color:red; margin-left:100px; font-size: 20px; font-weight: bold;"><% 
...
<div class="register">       
     <h5>300,000+ live jobs</h5> 
     <h6>14,000+ recruiters</h6>
     <h4> 2.5 crores+ registered candidates </h4>
</div>
  <div class="reg1"> 
         <a href="./test3">Register</a>  
  </div>
