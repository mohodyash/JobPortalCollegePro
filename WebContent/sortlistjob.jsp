...
<html>
    ...
    <body>
        ...
        <div class="list">                                                           <!-- list -->
            <ul>
                ...
                <li><a href="contactus.jsp"><p> CONTACT US</p></a></li>
            </ul>
        </div>
        </div> 
    ...
    %></p></a>
     ...
     <div style="font-size: 22px; margin-left: 200px;">
         <%  
          int size=(int)request.getAttribute("size"); 
          for(int i=0;i<size;i++)
          {%>
             <lable>Post :: </lable><% out.print(request.getAttribute("post"+i)); %><br>
             <lable>Company Name:: </lable><% out.print(request.getAttribute("company"+i)); %>
          <br><br><%} %>     
     </div>
