...
<html>
    <head>
        <title>OnlySeekerCanApply</title>
    ...
    <div style="margin-left: 250px; margin-top: 50px; color: gray;">
     <h4 style="font-family: serif; font-size: 17px; color: red;">Error : </h4>
     <h3 style="margin-top: 10px;">* Sorry Only Seeker Can Not Apply For The Job </h3>
     <h3 style="margin-top: 10px;">* If You Are Not Seeker You Can Not Apply For Job</h3>
     <h3 style="margin-top: 10px;">* Please Go Back And Login To Seeker And Then Apply</h3>
    </div>
